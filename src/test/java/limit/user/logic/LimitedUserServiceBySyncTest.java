...
@SpringBootTest
public class LimitedUserServiceBySyncTest {
	@Autowired
	@Qualifier(value = "LimitedUserServiceBySync")
	...
	public void multiThreadTest() {
		...
		assertThat(service.getLimittedUserTotalCount()).isEqualTo(LimitedUserServiceBySync.LIMIT_COUNT);
	}
}